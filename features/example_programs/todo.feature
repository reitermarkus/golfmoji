# TODO: These should also be converted into cucumber features.

# module Golfmoji#
#   p 'result:'
#   p Executor.new(['⛳', ' ', '✂', '-', '🔗'], ARGV).execute
#
#   p 'result:'
#   p Executor.new(['⛳', ' ', '✂', '⛳', '✏'], ARGV).execute
#
